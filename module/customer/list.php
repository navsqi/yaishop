<?php
    ...
    $queryAdmin = mysqli_query($koneksi, "SELECT * FROM customer ORDER BY nama ASC");
        ...
        echo "<table class='table-list'>";
            ...
            while($rowUser=mysqli_fetch_array($queryAdmin))
            {
                echo "<tr>
                        ...
                        <td class='tengah'><a class='tombol-action' href='".BASE_URL."index.php?page=my_profile&module=customer&action=form&customer_id=$rowUser[customer_id]"."'>Edit</a></td>
                     </tr>";
